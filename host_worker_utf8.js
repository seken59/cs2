...
Last login: Sun May 31 16:00:20 2026 from 195.174.240.67

cd /home/cs.serkaneken.com/public_html
cat host_worker.js
...
Log in https://193.164.7.165:8090

Current Server time : 2026-05-31 16:00:48.
Current Load average: 0.53, 0.42, 0.56
Current CPU usage   : 1.75967%.
Current RAM usage   : 2600/15731MB (16.53%).
Current Disk usage  : 29/70GB (41%).
System uptime       : 1 days, 1 hours, 54 minutes.

Enjoy your accelerated Internet by CyberPanel.

]0;root@vps:~[?2004h[root@vps ~]# cd /home/cs.serkaneken.com/public_html
[?2004l
]0;root@vps:/home/cs.serkaneken.com/public_html[?2004h[root@vps public_html]# cat host_worker.js
[?2004l
...
async function processQueue() {
    ...
    try {
        ...
        const conn = db.promise().getConnection();
        try {
...
]0;root@vps:/home/cs.serkaneken.com/public_html[?2004h[root@vps public_html]# 
[?2004l
