...
- **Matchmaking (XP) Stratejisi:** Batch Size = 4. 2 lobi (2v2) aynı anda Wingman (Yoldaş) arayıp birbiriyle eşleşecek. CT takımı sürenin bitmesini bekleyerek raundu kazanıp (Time-Out XP) maçları tamamlayacak.
...
- **Güvenlik / Otomasyon:** 
  ...
  - Maç içi otomasyon için konsol üzerinden rastgele tuş enjeksiyonları yapılacak.
  - **Macro Engine V2 (Input Automation):** Botlar sadece ortada buluşup ölmez. Haritanın 4 farklı rotasından rastgele birini seçip yürür. Adım süreleri +- %10 Fuzzing (rastgelelik) içerir. Ateş ederken Spray (geniş açı) atarlar.
